...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      marketplace_flows: {
        Row: {
          ...
          description: string | null;
          failure_classification: Database["public"]["Enums"]["failure_classification"] | null;
          id: string;
    ...
    Enums: {
      ...
      email_pref_category: "billing" | "analytics" | "recovery" | "product" | "marketing";
      ...
      support_category:
        ...
        | "account"
        | "other";
      support_delivery_status: "sending" | "sent" | "delivered" | "seen" | "failed";
      ...
      support_presence_status: "online" | "available" | "busy" | "away" | "offline";
      support_priority: "low" | "normal" | "high" | "urgent" | "critical";
      support_status: "open" | "pending" | "waiting" | "resolved" | "closed" | "archived";
...
export const Constants = {
  public: {
    Enums: {
      ...
      recovery_channel: ["email", "whatsapp"],
      recovery_event_status: ["new", "analyzing", "recovering", "recovered", "abandoned", "failed"],
      subscription_status: [
        "on_trial",
        "active",
        "paused",
