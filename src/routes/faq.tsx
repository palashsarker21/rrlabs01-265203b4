...
const FAQS = [
  ...
  },
  {
    ...
    a: "Stripe, LemonSqueezy, Paddle, and any provider exposing a webhook for failed payments.",
  },
  {
    q: "Do I need to write recovery copy?",
    a: "No. Our AI generates copy tuned to your brand voice, customer segment, and decline reason. You can edit or approve before send.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. All credentials are encrypted server-side with AES-256. Row-level security scopes every read and write to your workspace.",
  },
  {
    q: "Can I cancel anytime?",
    a: "Yes. Plans are month-to-month. Annual plans include a pro-rated refund within 14 days.",
  },
];
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FAQ — RRLabs" },
      {
        ...
        content: "Frequently asked questions about RRLabs revenue recovery.",
      },
    ],
