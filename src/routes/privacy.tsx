      ...
      <LegalPage title="Privacy Policy" updated="July 2026">
        ...
        <ul>
          ...
          <li>
            ...
            transaction identifiers, tax information required by our Merchant of Record, and invoice
            references. Payment card details are never seen or stored by {BRAND.name}.
          </li>
          <li>
          ...
          <li>
            <strong>Support and communications</strong> — messages you send to us and metadata about
            those interactions.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>Billing, tax, and fraud prevention</strong> — compliance with legal obligations
        ...
        <p>
          ...
          WhatsApp Business messaging, error monitoring, product analytics, and payment processing
          (Lemon Squeezy). A current list of sub-processors is available on request via{" "}
        ...
        <p>
          ...
          protected by the European Commission's Standard Contractual Clauses, the UK International
          Data Transfer Addendum, or equivalent safeguards.
        </p>
        ...
        <p>
          ...
          right to know, delete, correct, and limit the use of sensitive personal information. We do
          not sell personal data and do not share personal data for cross-context behavioral
        ...
        <p>
          ...
          personal data, including encryption in transit and at rest, tenant isolation via row-level
          security, least-privilege access, audit logging, and continuous monitoring. Learn more on
          our <a href="/security">Security</a> page.
        </p>
        ...
        <p>
          ...
          through the Services or by email. The "Last updated" date at the top of this page always
        ...
        <p>
          ...
          individuals also have the right to lodge a complaint with a supervisory authority in their
