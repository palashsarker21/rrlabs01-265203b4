  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LegalPage title="Refund Policy" updated="July 2026">
        ...
        <h2>Monthly plans</h2>
        <p>Cancel any time. No pro-rated refunds; access continues through the end of the billing period.</p>
        <h2>Annual plans</h2>
        <p>Full refund within 14 days of purchase. After 14 days, pro-rated refund on remaining unused months, minus a 5% administrative fee.</p>
