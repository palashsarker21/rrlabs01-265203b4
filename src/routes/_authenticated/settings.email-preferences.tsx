    ...
    <div className="mx-auto max-w-2xl p-6 space-y-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Choose which non-essential emails you'd like to keep receiving from RRLabs.
          Security-critical emails (payment failures, invitations, password resets, system alerts)
          always send.
        </p>
      </header>
