...
export const APP_NAV: AppNavGroup[] = [
  ...
  },
  {
    ...
    icon: Users,
    items: [
      { id: "customers-directory", label: "Customers", to: "/platform/customers", icon: Users, keywords: ["customers", "directory"], adminOnly: true },
  ...
  },
  {
    ...
    icon: Bot,
    items: [
      { id: "ai-providers", label: "AI Providers", to: "/platform/ai", icon: Bot, keywords: ["providers", "openrouter"], adminOnly: true },
      { id: "ai-routes", label: "AI Routes", to: "/platform/ai", icon: Workflow, keywords: ["routes", "routing"], adminOnly: true },
      { id: "prompt-library", label: "Prompt Library", to: "/platform/ai", icon: Sparkles, keywords: ["prompts"], adminOnly: true },
      { id: "prompt-versions", label: "Prompt Versions", to: "/platform/ai", icon: ScrollText, keywords: ["versions"], adminOnly: true },
      { id: "ai-analytics", label: "AI Analytics", to: "/platform/ai/analytics", icon: BarChart3, keywords: ["ai", "cost", "latency"], adminOnly: true },
